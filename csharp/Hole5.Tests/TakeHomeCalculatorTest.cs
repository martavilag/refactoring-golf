...
namespace Hole5.Tests
{
    public class TakeHomeCalculatorTest
    {
        ...
        {
            int first = new TakeHomeCalculator(TaxRate.Of(TaxRate.Of(10))).NetAmount(Money.Create(40, "GBP"),
                Money.Create(50, "GBP"),
        ...
        {
            Assert.Throws<Incalculable>(() => new TakeHomeCalculator(TaxRate.Of(TaxRate.Of(10))).NetAmount(
